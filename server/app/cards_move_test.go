...
func TestMoveCardsToBoard(t *testing.T) {
	...
	t.Run("success scenario", func(t *testing.T) {
		...
		err := th.App.MoveCardsToBoard([]string{"card-id"}, testBoardID, testTargetBoardID, testMoveUserID)
	...
	t.Run("no card ids is a no-op", func(t *testing.T) {
		err := th.App.MoveCardsToBoard([]string{}, testBoardID, testTargetBoardID, testMoveUserID)
		require.NoError(t, err)
	})
	...
	t.Run("store error is propagated", func(t *testing.T) {
		...
		err := th.App.MoveCardsToBoard([]string{"card-id-3"}, testBoardID, testTargetBoardID, testMoveUserID)
...
func TestMoveCardsToBoardRejections(t *testing.T) {
	...
	t.Run("the same board is rejected", func(t *testing.T) {
		err := th.App.MoveCardsToBoard([]string{"card-id"}, testBoardID, testBoardID, testMoveUserID)
		require.ErrorIs(t, err, ErrMoveToSameBoard)
	})

	t.Run("a board of another team is rejected", func(t *testing.T) {
		err := th.App.MoveCardsToBoard([]string{"card-id"}, testBoardID, otherTeamBoardID, testMoveUserID)
		require.ErrorIs(t, err, ErrMoveAcrossTeams)
	})

	t.Run("a template board is rejected", func(t *testing.T) {
		err := th.App.MoveCardsToBoard([]string{"card-id"}, testBoardID, templateBoardID, testMoveUserID)
	...
	t.Run("a template card is rejected", func(t *testing.T) {
		...
		err := th.App.MoveCardsToBoard([]string{"template-card-id"}, testBoardID, testTargetBoardID, testMoveUserID)
	...
	t.Run("a card of another board is rejected", func(t *testing.T) {
		...
		err := th.App.MoveCardsToBoard([]string{"foreign-card-id"}, testBoardID, testTargetBoardID, testMoveUserID)
	...
	t.Run("a block that is not a card is rejected", func(t *testing.T) {
		...
		err := th.App.MoveCardsToBoard([]string{"text-block-id"}, testBoardID, testTargetBoardID, testMoveUserID)
		require.ErrorIs(t, err, model.ErrNotCardBlock)
	})
	...
	t.Run("a deleted card is reported as not found", func(t *testing.T) {
		...
		err := th.App.MoveCardsToBoard([]string{"deleted-card-id"}, testBoardID, testTargetBoardID, testMoveUserID)
